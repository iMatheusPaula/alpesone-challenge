...
class UpdateCarRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'model_year' => ['sometimes', 'nullable', 'string', 'max:4'],
            'build_year' => ['sometimes', 'nullable', 'string', 'max:4'],

            // JSON/array fields
            'optionals' => ['sometimes', 'nullable', 'array'],
            'photos' => ['sometimes', 'nullable', 'array'],

            'doors' => ['sometimes', 'nullable', 'string', 'max:50'],
            'board' => ['sometimes', 'nullable', 'string', 'max:100'],
            'chassi' => ['sometimes', 'nullable', 'string', 'max:100'],
            'transmission' => ['sometimes', 'nullable', 'string', 'max:100'],
            'km' => ['sometimes', 'nullable', 'string', 'max:50'],
            'description' => ['sometimes', 'nullable', 'string'],
            'sold' => ['sometimes', 'boolean'],
            'category' => ['sometimes', 'nullable', 'string', 'max:255'],
            'url_car' => ['sometimes', 'nullable', 'url'],
            'price' => ['sometimes', 'nullable', 'numeric'],
            'old_price' => ['sometimes', 'nullable', 'numeric'],
            'color' => ['sometimes', 'nullable', 'string', 'max:100'],
            'fuel' => ['sometimes', 'nullable', 'string', 'max:100'],
        ];
    }
